...
<html lang="en">
   <head>
      ...
      <title>Packagess - Pending Pick-Up</title>
         ...
         <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
               ...
               <div class="container-fluid">
                  <!-- Content Row -->
                  <div class="row">
                     <h2 class="font-weight-bold text-warning">Pending Pick-Up</h2>
                     <div class="table-responsive">
                        <table class="table">
                           ...
                           <tbody>
                                 ...
                                 mysqli_select_db($conn, "packagess");
                                 $query = "SELECT * FROM pending_packages;";
